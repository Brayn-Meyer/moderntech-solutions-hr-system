...
export const editEmployee = async (name, position, department, salary, employmentHistory, contact, employeeId) => {
  try {
    await pool.query(`UPDATE employeeinformation SET name = ?, position = ?, department = ?, salary = ?, employmentHistory = ?, contact = ? WHERE employeeId = ?;`,
